...
namespace lost_clothes_code
{
    public class niveau_5_3 : GameScreen
    {
        ...
        {
            _perso = new Sprite(45, 27, 200, 2, 100, 100, "d_idle", Content.Load<SpriteSheet>("chevalier_2.sf", new JsonContentLoader()), Content.Load<TiledMap>("Maps/map_5_3"));
            _bulle = new Sprite(23, 45, 100, 2, 385, 340, "electricite_bas_1", Content.Load<SpriteSheet>("feu.sf", new JsonContentLoader()), Content.Load<TiledMap>("Maps/map_5_3"));
