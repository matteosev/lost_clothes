...
namespace lost_clothes_code
{
    public class niveau_4_1 : GameScreen
    {
        ...
        public override void Initialize()
        {
            ...
            _perso = new Perso(45, 27, 200, 2, 10, 10, "d_idle", Content.Load<SpriteSheet>("chevalier_2.sf", new JsonContentLoader()));
            _bulle = new Perso(23, 45, 100, 2, 450, 250, "feu_1", Content.Load<SpriteSheet>("feu.sf", new JsonContentLoader()));
