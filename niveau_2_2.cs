...
{
    public class niveau_2_2 : GameScreen
    {
        ...
        public niveau_2_2(Game1 game) : base(game)
        {
        ...
        {
            _tiledMap = Content.Load<TiledMap>("Maps/map_2_2");
            _tiledMapRenderer = new TiledMapRenderer(GraphicsDevice, _tiledMap);
            _spriteBatch = new SpriteBatch(GraphicsDevice);

            _perso = new Sprite(45, 27, 200, 2, 700, 380, "d_idle", Content.Load<SpriteSheet>("chevalier_1.sf", new JsonContentLoader()), _tiledMap);
        }
