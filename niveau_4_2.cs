...
{
    public class niveau_4_2 : GameScreen
    {
        ...
        public niveau_4_2(Game1 game) : base(game)
        {
        ...
        public override void Initialize()
        {
            ...
            _perso = new Perso(45, 27, 200, 2, 100, 100, "d_idle", Content.Load<SpriteSheet>("chevalier_3.sf", new JsonContentLoader()));
            _bulle = new Perso(23, 45, 100, 2, 380, 380, "feu_1", Content.Load<SpriteSheet>("feu.sf", new JsonContentLoader()));
        ...
        {
            _tiledMap = Content.Load<TiledMap>("Maps/map_4_2");
