...
{
    public class niveau_2_4 : GameScreen
    {
        ...
        public niveau_2_4(Game1 game) : base(game)
        {
        ...
        {
            _tiledMap = Content.Load<TiledMap>("Maps/transition_2_3");
            _tiledMapRenderer = new TiledMapRenderer(GraphicsDevice, _tiledMap);
            _spriteBatch = new SpriteBatch(GraphicsDevice);

            SpriteSheet spriteSheetItem = Content.Load<SpriteSheet>("item_2.sf", new JsonContentLoader());
            _item = new AnimatedSprite(spriteSheetItem);
            _perso = new Sprite(45, 27, 200, 2, 90, 380, "d_idle", Content.Load<SpriteSheet>("chevalier_2.sf", new JsonContentLoader()), _tiledMap);
        ...
        public override void Update(GameTime gametime)
        {
            ...
            {
                _perso.SpriteSheet = Content.Load<SpriteSheet>("chevalier_2.sf", new JsonContentLoader());
