...
namespace lost_clothes_code
{
    public class niveau_2_4 : GameScreen
    {
        ...
        public override void LoadContent()
        {
            ...
            SpriteSheet spriteSheet = Content.Load<SpriteSheet>("chevalier_1.sf", new JsonContentLoader());
            _perso = new AnimatedSprite(spriteSheet);

            SpriteSheet spriteSheetPerso = Content.Load<SpriteSheet>("chevalier_2.sf", new JsonContentLoader());
